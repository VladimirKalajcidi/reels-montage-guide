"""Автопроверки ролика 7 («инженер компьютерного зрения») — delivery-specs.md §6.
...
from storyboard41 import SHOTS, DUR
import render41 as R
...
if __name__ == "__main__":
    print("=== QA ролик 7 («инженер компьютерного зрения») ===")
