"""Сборка ролика 4 («CFD-инженер»). Речь не резана — резы только по картинке.
...
from style import *
from storyboard4 import SHOTS, CAPS, SLOTS, DUR, LABELS, NUMS
...
def main():
    ...
    tmp = f"{BUILD}/assets/_video4.mp4"
    ff = subprocess.Popen(
