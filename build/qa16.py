...
from storyboard16 import OUT, SHOTS, CAPS, DUR, GFX_ZONE, GFX_X, FACE_KINDS, shot_at
...
def line_overlaps():
    ...
    for i in range(len(CAPS) - 1):
        ...
        slot = render16.SLOTS[render16.slot_for(shot_at(CAPS[i][0])[2])]
...
def gfx_in_zone():
    ...
    for f in range(0, int(DUR * FPS), 2):
        ...
        gl = render16.graphics_layer(kind, t - ts)
        if gl is None:
            continue
