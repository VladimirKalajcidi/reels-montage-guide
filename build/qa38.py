"""Автопроверки ролика 3 («криптограф») — delivery-specs.md §6. Обе должны дать ноль."""
import os, sys
import numpy as np
import cv2
...
from storyboard38 import SHOTS, DUR
import render38 as R
