"""Звук ролика 5 («квантовые вычисления»): синтез SFX + микс с голосом. Уровни — delivery-specs.md §5."""
import os, sys, subprocess, wave
import numpy as np

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from storyboard39 import SHOTS, DUR, NUMBERS

BUILD = os.path.dirname(os.path.abspath(__file__))
SRC = "/Users/vladimirkalajcidi/reels_good2/videos/5/source.mov"
VID = f"{BUILD}/assets/_video39.mp4"
...
def main():
    tmp = f"{BUILD}/assets/_voice39.wav"
    ...
    if os.path.exists(music_path):
        mw = f"{BUILD}/assets/_music39.wav"
