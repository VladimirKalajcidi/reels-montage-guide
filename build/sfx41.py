"""Звук ролика 7 («инженер компьютерного зрения»): синтез SFX + микс с голосом.
Уровни — delivery-specs.md §5. Слот 41 — см. docstring storyboard41.py."""
import os, sys, subprocess, wave
import numpy as np

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from storyboard41 import SHOTS, DUR, NUM_REVEALS

BUILD = os.path.dirname(os.path.abspath(__file__))
SRC = "/Users/vladimirkalajcidi/reels_good2/videos/7/source.mov"
VID = f"{BUILD}/assets/_video41.mp4"
...
def main():
    tmp = f"{BUILD}/assets/_voice41.wav"
    ...
    if os.path.exists(music_path):
        mw = f"{BUILD}/assets/_music41.wav"
