"""Сборка ролика 9 («баллистик» — расчёт траекторий космических аппаратов).
Речь не резана — резы только по картинке. Слот 42 — см. docstring
storyboard42.py и videos/9/status.md (слот 9 был занят чужим комплектом,
подмена материала).
...
from style import *
from storyboard42 import SHOTS, CAPS, SLOTS, DUR, NUMS

BUILD = os.path.dirname(os.path.abspath(__file__))
SRC = "/Users/vladimirkalajcidi/reels_good2/videos/9/source.mov"
VIDEO_DIR = os.path.dirname(SRC)
A1 = f"{BUILD}/assets/aroll_42_A1.mp4"
A2 = f"{BUILD}/assets/aroll_42_A2.mp4"
OUT = "/Users/vladimirkalajcidi/reels_good2/videos/9/ballistician_edit.mp4"
...
def prep_stock():
    ...
    for i, (t0, t1, kind, prm) in enumerate(SHOTS):
        ...
        dst = f"{STOCK_PREP_DIR}/sb42_{i}_{prm['clip']}.mp4"
...
def main():
    ...
    tmp = f"{BUILD}/assets/_video42.mp4"
    ff = subprocess.Popen(
