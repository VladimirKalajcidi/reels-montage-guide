"""Звук ролика 4 («CFD-инженер»): синтез SFX + микс с голосом. Уровни — delivery-specs.md §5."""
import os, sys, subprocess, wave
import numpy as np

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from storyboard4 import SHOTS, DUR, NUM_REVEALS

BUILD = os.path.dirname(os.path.abspath(__file__))
SRC = "/Users/vladimirkalajcidi/reels_good2/videos/4/source.mov"
VID = f"{BUILD}/assets/_video4.mp4"
OUT = "/Users/vladimirkalajcidi/reels_good2/videos/4/cfd_edit.mp4"
SR = 48000
...
def main():
    tmp = f"{BUILD}/assets/_voice4.wav"
