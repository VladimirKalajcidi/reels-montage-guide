...
from storyboard34 import SRC, SHOTS, shot_at
from style import FPS
import render34

OUTDIR = sys.argv[1] if len(sys.argv) > 1 else "/private/tmp/claude-501/-Users-vladimirkalajcidi-reels-good/e75e263d-4975-4abf-bf9e-54c9f093fbeb/scratchpad/contact34"
...
for t in TIMES:
    ...
    canvas = render34.compose(kind, prm, fr, t, t0)
