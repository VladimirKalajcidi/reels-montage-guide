"""Звук ролика 8 («аналитик спроса»): синтез SFX + микс с голосом. Уровни — delivery-specs.md §5."""
import os, sys, subprocess, wave
import numpy as np

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from storyboard40 import SHOTS, DUR, NUMBERS

BUILD = os.path.dirname(os.path.abspath(__file__))
SRC = "/Users/vladimirkalajcidi/reels_good2/videos/8/source.mov"
VID = f"{BUILD}/assets/_video40.mp4"
OUT = "/Users/vladimirkalajcidi/reels_good2/videos/8/analyst_edit.mp4"
SR = 48000

# impact — на ревиле числа (и белого, и синего — оба меряются на слух, разницы уровня нет)
NUM_REVEALS = [n["t0"] + 0.05 for n in NUMBERS]
...
def main():
    tmp = f"{BUILD}/assets/_voice40.wav"
    ...
    if os.path.exists(music_path):
        mw = f"{BUILD}/assets/_music40.wav"
