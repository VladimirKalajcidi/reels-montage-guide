"""Звук ролика 34: SFX + тихая музыка + исходная речь без резки.

Постель: whoosh на каждой из 20 склеек, импакт под белым ревилом 2000 и под
тремя синими выводами (галочка «угадал», крест «не угадал», замыкание петли),
...
from storyboard34 import SHOTS, DUR, NUM_REVEALS, CASCADES, SRC, OUT, TAG
