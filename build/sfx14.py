"""Звук ролика 14: SFX + тихая музыка + исходная речь без резки."""
import os
import subprocess
import sys
import wave
...
from storyboard14 import SHOTS, DUR, NUM_REVEALS, CASCADES, SRC, OUT
...
def main():
    tmp = f"{BUILD}/assets/_voice_kepler.wav"
    ...
    if os.path.exists(MUSIC):
        mw = f"{BUILD}/assets/_music_kepler.wav"
    ...
    if mx > 0.99:
        mix *= 0.99 / mx
    out_wav = f"{BUILD}/assets/_mix_kepler.wav"
