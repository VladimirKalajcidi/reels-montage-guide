"""Звук ролика 9 («баллистик»): синтез SFX + микс с голосом.
Уровни — delivery-specs.md §5. Слот 42 — см. docstring storyboard42.py."""
import os, sys, subprocess, wave
import numpy as np

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from storyboard42 import SHOTS, DUR, NUM_REVEALS

BUILD = os.path.dirname(os.path.abspath(__file__))
SRC = "/Users/vladimirkalajcidi/reels_good2/videos/9/source.mov"
VID = f"{BUILD}/assets/_video42.mp4"
...
def main():
    tmp = f"{BUILD}/assets/_voice42.wav"
    ...
    if os.path.exists(music_path):
        mw = f"{BUILD}/assets/_music42.wav"
