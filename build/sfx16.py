"""Звук ролика 16: SFX + тихая музыка + исходная речь без резки."""
import os
import subprocess
import sys
import wave
...
from storyboard16 import SHOTS, DUR, NUM_REVEALS, CASCADES, SRC, OUT
...
def main():
    tmp = f"{BUILD}/assets/_voice_a4.wav"
    ...
    if os.path.exists(MUSIC):
        mw = f"{BUILD}/assets/_music_a4.wav"
    ...
    if mx > 0.99:
        mix *= 0.99 / mx
    out_wav = f"{BUILD}/assets/_mix_a4.wav"
