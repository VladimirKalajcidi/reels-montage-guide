"""Автопроверки ролика 9 («баллистик») — delivery-specs.md §6.
Обе должны дать ноль."""
import os, sys
import numpy as np
import cv2
...
from storyboard42 import SHOTS, DUR
import render42 as R
...
if __name__ == "__main__":
    print("=== QA ролик 9 («баллистик») ===")
    n1 = check_text_outside_card()
    n2 = check_line_overlap()
    print()
    ok = n1 == 0 and n2 == 0
    print("ИТОГО:", "ПРОШЕЛ" if ok else f"брак: outside={n1} overlap={n2}")
