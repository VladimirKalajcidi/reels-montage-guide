...
from storyboard33 import SRC, SHOTS, shot_at
from style import FPS
import render33

OUTDIR = sys.argv[1] if len(sys.argv) > 1 else "/private/tmp/claude-501/-Users-vladimirkalajcidi-reels-good/b9aec424-5570-4a6e-bda8-7ddb47ef122d/scratchpad/contact33"
...
for t in TIMES:
    ...
    canvas = render33.compose(kind, prm, fr, t, t0)
