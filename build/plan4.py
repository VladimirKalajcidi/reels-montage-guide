"""Генерирует монтажный лист ролика 4 («CFD-инженер») из раскадровки."""
import sys, os
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from storyboard4 import SHOTS, CAPS, DUR, NAMES, STOCK
...
print("# Монтажный лист — «CFD-инженер» (профессии, требующие математики)\n")
print("Исходник: `videos/4/source.mov` · 720×1280 → холст 1080×1920 · 30 fps · "
      f"{DUR:.2f}с")
print("Готовый ролик: `videos/4/cfd_edit.mp4`\n")
...
print("Видео — Mixkit (свободная лицензия, коммерческое использование без атрибуции), "
      ...
      "в `videos/4/stock/`, изолированы под этот ролик, каждый клип использован ровно один раз.")
print("\n## Звук")
