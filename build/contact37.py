"""Контакт-лист ключевых кадров ролика 37 — смысловая проверка графики глазами."""
import os
import sys
...
from storyboard37 import SRC, SHOTS, shot_at
from style import FPS
import render37

OUTDIR = sys.argv[1] if len(sys.argv) > 1 else "/private/tmp/contact37"
...
for t in TIMES:
    ...
    canvas = render37.compose(kind, prm, fr, t, t0)
