"""Звук ролика 2 («актуарий»): синтез SFX + микс с голосом. Уровни — delivery-specs.md §5."""
import os, sys, subprocess, wave
import numpy as np

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from storyboard3 import SHOTS, DUR, NUMBERS

BUILD = os.path.dirname(os.path.abspath(__file__))
SRC = "/Users/vladimirkalajcidi/reels_good2/videos/2/source.mov"
VID = f"{BUILD}/assets/_video3.mp4"
...
def main():
    tmp = f"{BUILD}/assets/_voice3.wav"
    ...
    music_path = "/Users/vladimirkalajcidi/reels_good2/audios/song2.mp3"
    if os.path.exists(music_path):
        mw = f"{BUILD}/assets/_music3.wav"
