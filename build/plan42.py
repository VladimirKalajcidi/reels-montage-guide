"""Генерирует монтажный лист ролика 9 («баллистик») из раскадровки."""
import sys, os
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from storyboard42 import SHOTS, CAPS, DUR, NAMES, STOCK
...
print("# Монтажный лист — «баллистик» (профессии, требующие математики)\n")
print("Исходник: `videos/9/source.mov` · 720×1280 → холст 1080×1920 · 30 fps · "
      f"{DUR:.2f}с")
print("Готовый ролик: `videos/9/ballistician_edit.mp4`\n")
...
print("Видео — Mixkit (свободная лицензия, коммерческое использование без атрибуции), "
      ...
      "в `videos/9/stock/`, изолированы под этот ролик, каждый клип использован ровно один раз.")
print("\n## Звук")
print("Голос без резов, whoosh на каждом резе картинки (0.040 от пика), impact на "
      "ревиле каждого белого числа (0.070), музыка `audios/song1.mp3` (−19 dB от RMS "
